...
public class AddEmployeePage extends JPanel {
    ...
    private JLabel employeeDept;
    private JToggleButton save;
    private JToggleButton back;

    public AddEmployeePage(String n, String p) {
        createUI(n, p);
    }
    public void createUI(String n, String p){
        ...
        employeeDept = new JLabel ("Department:");
        ...
        save.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                boolean t = a.AddEmployee(usernameField.getText(), passField.getText(), nameField.getText(), deptName);
                if(t == false)
                {
        ...
        employeeName.setBounds (175, 70, 100, 25);
