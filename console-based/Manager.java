...
public class Manager extends User implements Observer
{
    ...
    public void assignComplaint(Complaint c)
    {
        List<Employee> ChosenEmp = selectEmployees();
        StringBuilder assignedEmployeesLine = new StringBuilder();

        for(Employee emp: ChosenEmp)
        {
        ...
        //save emp username with this complaint in complaint file
        //c.setState(new ResolvedState(c));
        c.assign(c);    //at this point complaint will have new state and new state's assign function will be called 
    }
    ...
    public void reviewComplaintSolution(int Cid, boolean satisfied)
    {
        ...
        else
        {
            ...
            //System.out.print("sol " + c.getSolution());
